...
goog.exportSymbol('proto.grpc.post.v1.PostsResponse', null, global);
 ...
 * @constructor
 */
proto.grpc.post.v1.PostsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.grpc.post.v1.PostsResponse.repeatedFields_, null);
};
goog.inherits(proto.grpc.post.v1.PostsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.grpc.post.v1.PostsResponse.displayName = 'proto.grpc.post.v1.PostsResponse';
}
/**
 ...
 * @const
 */
proto.grpc.post.v1.PostsResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.grpc.post.v1.PostsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.grpc.post.v1.PostsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.grpc.post.v1.PostsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.grpc.post.v1.PostsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.grpc.post.v1.PostsResponse}
 */
proto.grpc.post.v1.PostsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.grpc.post.v1.PostsResponse;
  return proto.grpc.post.v1.PostsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.grpc.post.v1.PostsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.grpc.post.v1.PostsResponse}
 */
proto.grpc.post.v1.PostsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.grpc.post.v1.PostsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.grpc.post.v1.PostsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.grpc.post.v1.PostsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.grpc.post.v1.PostsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.grpc.post.v1.PostsResponse.prototype.getPostsList = function() {
...
proto.grpc.post.v1.PostsResponse.prototype.setPostsList = function(value) {
 ...
 * @return {!proto.grpc.post.v1.PostDto}
 */
proto.grpc.post.v1.PostsResponse.prototype.addPosts = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.grpc.post.v1.PostDto, opt_index);
};


proto.grpc.post.v1.PostsResponse.prototype.clearPostsList = function() {
  this.setPostsList([]);
};
