...
function serialize_grpc_user_v1_GetUserDetailsResponse(arg) {
  if (!(arg instanceof user_pb.GetUserDetailsResponse)) {
    throw new Error('Expected argument of type grpc.user.v1.GetUserDetailsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_grpc_user_v1_GetUserDetailsResponse(buffer_arg) {
  return user_pb.GetUserDetailsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var UserService = exports.UserService = {
  ...
  getUserDetails: {
    path: '/grpc.user.v1.User/GetUserDetails',
    requestStream: false,
    responseStream: false,
    requestType: user_pb.GetByIdRequest,
    responseType: user_pb.GetUserDetailsResponse,
    requestSerialize: serialize_grpc_user_v1_GetByIdRequest,
    requestDeserialize: deserialize_grpc_user_v1_GetByIdRequest,
    responseSerialize: serialize_grpc_user_v1_GetUserDetailsResponse,
    responseDeserialize: deserialize_grpc_user_v1_GetUserDetailsResponse,
  },
};
